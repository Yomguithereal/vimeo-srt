...
k._srt.push(n);}});},findSuitableStep:function(){var k=j(this._srt,this._currentSecond);if(k.seconds_begin<=this._currentSecond){if((k.seconds_end+1)>=this._currentSecond){return k;
}else{return false;}}return false;}};d.fn[h]=function(k){return this.each(function(){if(!d.data(this,"plugin_"+h)){d.data(this,"plugin_"+h,new i(this,k));
